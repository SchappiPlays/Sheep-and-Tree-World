...
const pathFlat = [
    ...
    // Dragon's Reach approach bridge over river
    {x:1080,z:22},{x:1080,z:18},{x:1080,z:16},
];
...
const PATH_ROUTES = [
    ...
    // Farwatch (1020,30) → Dragon's Reach fortress (1080,-5) — crosses river via bridge
    [[1020,30],[1055,26],[1080,22],[1080,16]],
