...
const pathFlat = [
    ...
    // Dragon's Reach approach — west swing + bridge
    {x:968,z:22},{x:1010,z:22},{x:1050,z:22},{x:1080,z:22},{x:1080,z:18},{x:1080,z:16},
];
...
const PATH_ROUTES = [
    ...
    // Farwatch (1020,30) → Dragon's Reach fortress — swings west then sharp right to bridge
    [[1020,30],[995,26],[968,22],[1010,22],[1050,22],[1080,22],[1080,16]],
